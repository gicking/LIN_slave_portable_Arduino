...
// setup LIN node
LIN_Slave_HardwareSerial  LIN(Serial1, LIN_Slave_Base::LIN_V2, "Slave");
...
// called when byte was received via Serial1. This routine is called between loop() runs (not in background).
void serialEvent1()
{
